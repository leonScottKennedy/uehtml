...
$(function(){
	...
	$(".imacc .slideprev").click(function(){
	 ...
	 // 顶部无缝切换
	$iW = $("#autoplay ul li").width();
	$("#pics").css("width", $iW*$("#pics li").length);		// 2900px
    var iNow = 0;
	var iNow2 = 0;
	var iTimer = null;
	...
	/*$("#autoplay #pics li").hover(function(){
		$("#autoplay #pics li > div.info").css("transform", "translateY(-50px)");
	},function(){
		$("#autoplay #pics li > div.info").slideDown();
	});*/
	
	/*$("#autoplay #tab > a").hover(function(){
		$("#autoplay #pics li > div.info").slideDown();
	});*/
